# Multi Sensor Package
 This package allows monitoring the performance of the sensors depicted in the next image of individual manner and visualized in RVIZ. 
 ...
 1. ZED package:
    ...
    ```
      where Number of camera is:
           1 to visualize the front camera
           2 to visualize the front and left camera
           3 to visualize all the cameras
...
5. IMU package
   Do not forget to remove the USB permission 
   ```
   sudo chmod +x /dev/ttyUSB0
   ros2 launch multi-sensor only_imu.launch.py   
   ``` 
